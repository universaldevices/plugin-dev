...
class SwitchOptimizer(BaseOptimizer):
    ...
    The algorithm adjusts Switch settings based on grid conditions while respecting
    user comfort preferences. If a customer manually changes state during an active  
